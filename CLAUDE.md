...
Docker's buildkit caches the build context aggressively. `--no-cache` alone does NOT invalidate COPY steps — the builder's cache retains stale files. To force a truly clean rebuild:
